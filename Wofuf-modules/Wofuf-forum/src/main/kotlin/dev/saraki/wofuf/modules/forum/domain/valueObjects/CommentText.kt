...
class CommentText private constructor(
    ...
    companion object {
        ...
        fun create(value: String): Result<CommentText> {
            ...
            val minGuardResult = Guard.againstAtLeast(MIN_LENGTH, "MinLength")
            val maxGuardResult = Guard.againstAtMost(MAX_LENGTH, "MaxLength")

            if (minGuardResult.isFailure || maxGuardResult.isFailure) {
                return Result.failure(minGuardResult.exceptionOrNull() ?: maxGuardResult.exceptionOrNull()!!)
            }
