...
@RestController
@RequestMapping(ForumApiConstantV1.Admin.Posts.HIDE)
class HidePostController(
    ...
    @PostMapping
    fun hidePost(@PathVariable postId: String): ApiResponse<HidePostDto.Response> {
        ...
        val result = hidePostUseCase.execute(
            HidePostDto.Request(postId = postId, hiddenByMemberId = member.memberId.stringValue)
        ).getOrThrow()
